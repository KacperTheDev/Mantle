...
public abstract class TagCondition<T> implements ICondition {
  ...
  public record Serializer<C extends TagCondition<?> & LootItemCondition>(ResourceLocation getID, Function<TagKey<?>,C> constructor, MapCodec<C> codec) {
    public Serializer(ResourceLocation getID, Function<TagKey<?>,C> constructor) {
      this(getID, constructor, makeCodec(constructor));
    }

    private static <C extends TagCondition<?> & LootItemCondition> MapCodec<C> makeCodec(Function<TagKey<?>,C> constructor) {
