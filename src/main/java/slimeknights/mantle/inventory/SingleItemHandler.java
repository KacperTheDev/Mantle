...
public abstract class SingleItemHandler<T extends MantleBlockEntity> implements IItemHandlerModifiable {
   ...
   * Writes this module to NBT
   * @return  Module in NBT
   * @deprecated use {@link #writeToNBT(HolderLookup.Provider)}
   */
  @Deprecated(forRemoval = true)
  public CompoundTag writeToNBT() {
    return parent.getLevel() == null ? new CompoundTag() : writeToNBT(parent.getLevel().registryAccess());
  }
   ...
   * Reads this module from NBT
   * @param nbt  NBT
   * @deprecated use {@link #readFromNBT(CompoundTag, HolderLookup.Provider)}
   */
  @Deprecated(forRemoval = true)
  public void readFromNBT(CompoundTag nbt) {
    stack = parent.getLevel() == null ? ItemStack.EMPTY : ItemStack.parseOptional(parent.getLevel().registryAccess(), nbt);
  }
}
